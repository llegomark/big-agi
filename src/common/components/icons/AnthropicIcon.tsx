...
export function AnthropicIcon(props: { sx?: SxProps }) {
  return (
    <SvgIcon viewBox="10 15 225 225" width="24" height="24" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round" {...props}>
