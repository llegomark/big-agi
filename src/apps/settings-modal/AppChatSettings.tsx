...
export function AppChatSettings() {
  ...
  const {
    ...
    (state) => ({
      ...
      setEnterIsNewline: state.setEnterIsNewline,
  ...
  return (
    <>
      <FormControl orientation="horizontal" sx={{ justifyContent: 'space-between' }}>
        <FormLabelStart title="Enter sends ⏎" description={enterIsNewline ? 'New line' : 'Sends message'} />
        <Switch
          checked={!enterIsNewline}
          onChange={handleEnterIsNewlineChange}
      ...
      <FormControl orientation="horizontal" sx={{ justifyContent: 'space-between' }}>
        <FormLabelStart title="Markdown" description={renderMarkdown ? 'Render markdown' : 'As text'} />
        <Switch
      ...
      <FormControl orientation="horizontal" sx={{ justifyContent: 'space-between' }}>
        <FormLabelStart title="Edit mode" description={doubleClickToEdit ? 'Double click' : 'Three dots'} />
        <Switch
          checked={doubleClickToEdit}
          onChange={handleDoubleClickToEditChange}
      ...
      {SHOW_PURPOSE_FINDER && (
        <FormControl orientation="horizontal" sx={{ justifyContent: 'space-between' }}>
          <FormLabelStart title="Purpose finder" description={showPurposeFinder ? 'Show search bar' : 'Hide search bar'} />
          <Switch
      ...
      <FormControl orientation="horizontal" sx={{ justifyContent: 'space-between' }}>
        <FormLabelStart title="Auto Chat Title" description={autosetChatTitle ? 'LLM Titling' : 'Manual only'} />
        <Switch
          checked={autosetChatTitle}
          onChange={handleAutoSetChatTitleChange}
      ...
      <FormControl orientation="horizontal" sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
        <FormLabelStart title="Appearance" description={zenMode === 'clean' ? 'Show senders' : 'Minimal UI'} />
      ...
      {!isPwa() && (
        <FormControl orientation="horizontal" sx={{ ...hideOnMobile, alignItems: 'center', justifyContent: 'space-between' }}>
          <FormLabelStart title="Page Size" description={centerMode === 'full' ? 'Full screen chat' : centerMode === 'narrow' ? 'Narrow chat' : 'Wide'} />
