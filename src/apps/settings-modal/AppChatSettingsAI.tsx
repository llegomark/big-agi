  ...
  return (
    <>
      <FormControl orientation="horizontal" sx={{ justifyContent: 'space-between' }}>
        <FormLabelStart title="Auto Chat Title" description={autoTitleChat ? 'LLM Titling' : 'Manual only'} />
        <Switch
          checked={autoTitleChat}
      ...
      <FormControl orientation="horizontal" sx={{ justifyContent: 'space-between' }}>
        <FormLabelStart title="Auto Diagrams" description={autoSuggestDiagrams ? 'LLM Diagrams' : 'Disabled'} />
        <Switch
          checked={autoSuggestDiagrams}
          onChange={handleAutoSuggestDiagramsChange}
      ...
      <FormControl disabled orientation="horizontal" sx={{ justifyContent: 'space-between' }}>
        <FormLabelStart
          ...
          //   <>
          //     Vote{' '}
          //     <Link href="https://github.com/enricoros/big-agi/issues/228" target="_blank">
          //       #228
          //     </Link>
          //   </>
          // }
        />
        <Switch
          checked={autoSuggestQuestions}
          onChange={handleAutoSuggestQuestionsChange}
      ...
      <FormControl disabled orientation="horizontal" sx={{ justifyContent: 'space-between' }}>
        <FormLabelStart
          ...
          //   <>
          //     Vote{' '}
          //     <Link href="https://github.com/enricoros/big-agi/issues/227" target="_blank">
          //       #227
          //     </Link>
          //   </>
          // }
        />
        <Switch endDecorator={autoSuggestQuestions ? 'On' : 'Off'} slotProps={{ endDecorator: { sx: { minWidth: 26 } } }} />
      </FormControl>
    </>
  );
}
