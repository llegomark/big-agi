    ...
    items: [
      ...
      },
      {
        text: (
          <>
            <B>Azure</B> models{' '}
            <Link href="https://github.com/enricoros/big-agi/blob/main/docs/config-azure-openai.md" target="_blank">
              full support
            </Link>
            , incl. gpt-4-32k
          </>
    ...
    items: [
      {
        text: (
          <>
            New home page:{' '}
            <b>
              <Link href={Brand.URIs.Home + clientUtmSource()} target="_blank">
                {Brand.URIs.Home.replace('https://', '')}
              </Link>
            </b>
          </>
        ),
