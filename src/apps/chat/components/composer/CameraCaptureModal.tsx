...
export function CameraCaptureModal(props: { onCloseModal: () => void; onOCR: (ocrText: string) => void }) {
  ...
  // camera operations
  const { videoRef, cameras, cameraIdx, setCameraIdx, zoomControl, info, error, resetVideo } = useCameraCapture();
      ...
      >
        ...
        <Sheet variant="solid" invertedColors sx={{ zIndex: 10, display: 'flex', justifyContent: 'space-between', p: 1 }}>
          <Select
            ...
            color="neutral"
            value={cameraIdx}
            onChange={(_event: any, value: number | null) => setCameraIdx(value === null ? -1 : value)}
            indicator={<KeyboardArrowDownIcon />}
          >
            <Option value={-1}>No Camera</Option>
        ...
        <Box sx={{ position: 'relative' }}>
          <video
            ...
            style={{
              ...
              background: '#8888',
              opacity: ocrProgress !== null ? 0.5 : 1,
            }}
          />
