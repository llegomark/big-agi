...
export function AppLabs() {
  // external state
  const { experimentalLabs, setExperimentalLabs } = useUIPreferencesStore(
    (state) => ({
      experimentalLabs: state.experimentalLabs,
      setExperimentalLabs: state.setExperimentalLabs,
    }),
    shallow,
  );
  ...
  return (
    ...
    >
      ...
      <Container disableGutters maxWidth="sm">
        <Card>
          <CardContent>
            <Typography>The Labs section is where we experiment with new features and ideas.</Typography>
            <Typography level="title-md" sx={{ mt: 2 }}>
              Features {experimentalLabs ? 'enabled' : 'disabled'}:
            </Typography>
            <ul style={{ marginTop: 8, marginBottom: 8, paddingInlineStart: 32 }}>
              <li>
                <b>Text tools</b> - complete (highlight differences)
              </li>
              <li>
                <b>YouTube persona synthesizer</b> - alpha, not persisted
              </li>
              <li>
                <b>Chat mode: follow-up/augmentation</b> - alpha (diagrams)
              </li>
              <li>
                <b>Relative chats size</b> - complete
              </li>
            </ul>
            <Typography sx={{ mt: 2 }}>For any questions and creative idea, please join us on Discord, and let&apos;s talk!</Typography>
          </CardContent>
        </Card>
      </Container>
