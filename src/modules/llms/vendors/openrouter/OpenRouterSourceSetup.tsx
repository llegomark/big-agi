...
export function OpenRouterSourceSetup(props: { sourceId: DModelSourceId }) {
  // external state
  const { source, sourceHasLLMs, access, updateSetup } = useSourceSetup(props.sourceId, ModelVendorOpenRouter.getAccess);
  ...
  return (
    <>
      ...
      <Typography level="body-sm">
        ...
        is an independent, premium service granting access to{' '}
        <Link href="https://openrouter.ai/docs#models" target="_blank">
          exclusive models
        </Link>{' '}
        such as GPT-4 32k, Claude, and more, typically unavailable to the public.{' '}
        <Link href="https://github.com/enricoros/big-agi/blob/main/docs/config-openrouter.md">Configuration &amp; documentation</Link>.
      </Typography>
      {/*</Box>*/}
