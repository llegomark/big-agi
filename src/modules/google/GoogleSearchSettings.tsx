...
export function GoogleSearchSettings() {
  ...
  const { googleCloudApiKey, setGoogleCloudApiKey, googleCSEId, setGoogleCSEId } = useGoogleSearchStore(
    (state) => ({
      googleCloudApiKey: state.googleCloudApiKey,
      setGoogleCloudApiKey: state.setGoogleCloudApiKey,
      googleCSEId: state.googleCSEId,
      setGoogleCSEId: state.setGoogleCSEId,
    }),
    shallow,
  );
      ...
      <FormControl orientation="horizontal" sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
        <FormLabelStart
          ...
          description={
            <>
              Create one{' '}
              <Link href="https://console.cloud.google.com/apis/credentials" noLinkStyle target="_blank">
                here
              </Link>
            </>
          }
        ...
        <Input
          variant="outlined"
          placeholder={backendHasGoogle ? '...' : 'missing'}
          error={!isValidKey}
      ...
      <FormControl orientation="horizontal" sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
        <FormLabelStart
          ...
          description={
            <>
              Get it{' '}
              <Link href="https://programmablesearchengine.google.com/" noLinkStyle target="_blank">
                here
              </Link>
            </>
          }
